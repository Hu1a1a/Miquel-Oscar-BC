...
const Categoria = [
    ...
    { Name: "+ SIMPATICO", Icon: "assets/ICONS/simp.png", Descripcion: "Persona amigable y agradable que genera simpatía y buenas relaciones con los demás.", first: "LBS-Lara", second: "KRM-Kevin", third: "MGL-Manolo", music: "assets/categoria/Marc Anthony - Vivir Mi Vida (Letra  Lyrics) (mp3cut.net).mp3" },
    ...
    { Name: "+ GENUINO", Icon: "assets/ICONS/gen.png", Descripcion: "Persona auténtica y sincera, que se muestra tal como es sin fingimientos.", first: "LBS-Lara", second: "KRM-Kevin", third: "MGL-Manolo", music: "assets/categoria/Fangoria - Espectacular (Videoclip Oficial) (mp3cut.net).mp3" },
    ...
    { Name: "+ TIMIDO", Icon: "assets/ICONS/tim.png", Descripcion: "Persona reservada y con dificultades para interactuar socialmente por inseguridad.", first: "LBS-Lara", second: "KRM-Kevin", third: "MGL-Manolo", music: "assets/categoria/la cancion originanal de la pantera rosa.mp3" },
    ...
    { Name: "+ VERSATIL", Icon: "assets/ICONS/prud.png", Descripcion: "", first: "LBS-Lara", second: "KRM-Kevin", third: "MGL-Manolo", music: "assets/categoria/Mary Poppins - Supercalifragilisticoexpialidoso (mp3cut.net).mp3" },
    { Name: "+ EXIGENTE", Icon: "assets/ICONS/exig.png", Descripcion: "Individuo que demanda alta calidad y esfuerzo, tanto de sí mismo como de los demás.", first: "LBS-Lara", second: "KRM-Kevin", third: "MGL-Manolo", music: "assets/categoria/mix_1m12s (audio-joiner.com).mp3" },
]
